#!/usr/bin/env python3
"""
Script para analisar TODOS os leads pendentes de um tenant
"""
...
print("=" * 80)
print("ANÁLISE EM MASSA - ALLP FIT JP SUL")
print("=" * 80)
print()
...
print(f"💰 Custo estimado: R$ {total_pendentes * 0.0014:.2f} (aproximadamente)")
print()
...
with local_engine.connect() as conn:
    result = conn.execute(text("""
        ...
        FROM conversations_analytics
        WHERE tenant_id = 16 AND is_lead = true
    """))
